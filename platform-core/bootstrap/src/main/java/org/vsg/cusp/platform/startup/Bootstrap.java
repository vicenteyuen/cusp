package org.vsg.cusp.platform.startup;
...
import org.vsg.cusp.platform.startup.ClassLoaderFactory.Repository;
import org.vsg.cusp.platform.startup.ClassLoaderFactory.RepositoryType;
...
public class Bootstrap {
     ...
     * Daemon reference.
     */
    private Lifecycle catalinaDaemon = null;
    ...
    public void init() throws Exception {
        ...
        Lifecycle  serverLifecycle =  ServiceHelper.loadFactory(Lifecycle.class , catalinaLoader);
        ...
        if (serverLifecycle instanceof ClassLoaderAwareBean) {
        	ClassLoaderAwareBean clsLoader = (ClassLoaderAwareBean)serverLifecycle;
        	clsLoader.setParentClassLoader( sharedLoader );
        }
        // --- register bean ---
        catalinaDaemon = serverLifecycle;
    }
    ...
    private void load(String[] arguments)
        ...
        if (arguments==null || arguments.length==0) {
            ...
            param = argumentsList.toArray(new String[0]);
        }

        
        LoadMethodAwareBean loadMethodBean = (LoadMethodAwareBean)catalinaDaemon;
        if (null == param) {
        	loadMethodBean.load();
        }
        else {
        	loadMethodBean.load(param);
        }
