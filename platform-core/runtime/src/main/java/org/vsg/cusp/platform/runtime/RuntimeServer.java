...
import org.vsg.cusp.platform.api.LifecycleListener;
...
public class RuntimeServer implements Lifecycle , ClassLoaderAwareBean , LoadMethodAwareBean{
	
	private static Logger log = LoggerFactory.getLogger( RuntimeServer.class );
	...
	protected ClassLoader parentClassLoader = RuntimeServer.class.getClassLoader();
	...
	private List<ServEngine> registerServEngines = new ArrayList<ServEngine>();
