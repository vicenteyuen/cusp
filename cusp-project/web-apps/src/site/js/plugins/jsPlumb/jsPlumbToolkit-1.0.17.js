...
// if not an inline if, parse a normal attribute.
        ...
        counter = 0,
        _uuid = function() { return "" + (++counter);},

        b_uuid = function(fullLength) {
    ...
    _e(RotorsInstance.prototype, {
        ...
        parse:function(str, templateResolver, extraProperties) {
...
//            if (isCustomScope && originalTag && ast.length > 0) {
//                //ast[0].customTag = originalTag;
//                _rotors.executions[ast[0].uuid].customTag = originalTag;
//            }
...
(function () {
    ...
    var Base = function (data, graph) {
        ...
        Graph = exports.Graph = function (params) {
             ...
             * then you cannot use slashes (/) in your Node ids, as they will be treated as comps of a path
            ...
            var _getVertex = function (e, createPortsIfMissing) {
                ...
                if (path.length == 1) return _one(path[0]);
                    ...
                    // odd number of comps, since it consists of a series of node/graph entries followed by
                    // a final node id.
...
// common utility functions
    ...
    *  };
    ...
    exports.AbstractLayout = function (params) {
        ...
        /**
         * Called by comps to inform a layout that a given node was removed. You should never
 ...
 * This software is not free.
 *
 * This file contains the various UI comps offered by the jsPlumb Toolkit.
 *
...
// ---------- bind to events in the toolkit ---------------------
        ...
        if (this.bindToolkitEvents !== false) {
            ...
            //
            // Notification a Node was removed - this function removes all UI comps, and then calls refresh on the layout if there is
            // one.
            //
...
// -------------------------   public API -------------------------------------------------------
        ...
        /**
         * Nudges the wheel zoom by the given amount. This function is intended for use by comps that control
